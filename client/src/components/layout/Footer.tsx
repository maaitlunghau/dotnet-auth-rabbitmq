      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-base font-semibold text-text-primary">AuthGuard</span>
            </Link>
        ...
        <div className="mt-10 pt-6 border-t border-border-secondary flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="text-text-tertiary hover:text-text-primary transition-colors" aria-label="Email">
              <Mail size={18} />
            </a>
          </div>
        </div>
